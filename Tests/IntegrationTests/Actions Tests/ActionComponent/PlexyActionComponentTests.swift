...
class PlexyActionComponentTests: XCTestCase {
    ...
    func testRedirectToHttpWebLink() throws {
        let sut = PlexyActionComponent(context: Dummy.context)
    ...
    func testAwaitAction() throws {
        ...
        try waitUntilTopPresenter(isOfType: PlexyActions.AwaitViewController.self)
        ...
        (sut.presentationDelegate as! UIViewController).dismiss(animated: true) {
            ...
            XCTAssertNil(topPresentedViewController as? PlexyActions.AwaitViewController)
    ...
    func testRedirectableAwaitAction() throws {
        let expectedRedirectUrl = URL(string: "https://plexy.com")!
    ...
    func testTwintAction() throws {
        ...
        PlexyAssertion.listener = { assertion in
            XCTAssertEqual(assertion, "Twint action configuration instance must not be nil in order to use PlexyTwint")
    ...
    func testTwintActionConfiguration() throws {
        ...
        validSchemes.forEach { scheme in
            ...
            _ = PlexyActionComponent.Configuration.Twint(callbackAppScheme: scheme)
        }
    ...
    func testHandleRedirectEvent() {
        let redirectAction = RedirectAction(url: URL(string: "https://www.plexy.com")!, paymentData: "test_data")
    ...
    private func testEvent(for action: Action) {
        ...
        let sut = PlexyActionComponent(context: Dummy.context(with: analyticsProviderMock))
