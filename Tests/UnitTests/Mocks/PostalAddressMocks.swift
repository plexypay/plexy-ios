...
enum PostalAddressMocks {
    ...
    static let newYorkPostalAddress = PostalAddress(
        city: "New York",
        country: "US",
    ...
    static let losAngelesPostalAddress = PostalAddress(
        city: "Los Angeles",
        country: "US",
    ...
    static let singaporePostalAddress = PostalAddress(
        city: "Singapore",
        country: "SG",
    ...
    static let emptyUSPostalAddress = PostalAddress(
        city: "",
        country: "US",
        houseNumberOrName: "",
        postalCode: "",
