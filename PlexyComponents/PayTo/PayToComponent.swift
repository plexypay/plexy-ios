...
public final class PayToComponent: PaymentComponent, PresentableComponent, PlexyObserver, PaymentAware, LoadingComponent {
...
private extension PayToComponent {
    ...
    func didChangeSegment(_ index: Int) {
        ...
        default:
            PlexyAssertion.assertionFailure(message: "Segment index out of range")
        }
    }
