...
public final class UPIComponent: PaymentComponent,
    ...
    @PlexyObservable(.upiIntent) public private(set) var selectedUPIFlow: UPIFlowType
    ...
    internal lazy var modeInstructionsLabelItem: FormLabelItem = {
        ...
        item.style.color = .Plexy.componentLabel
...
extension UPIComponent {
    ...
    private func didChangeSegmentedControlIndex(_ index: Int) {
        PlexyAssertion.assert(message: "UPI flow type is out of range", condition: UPIFlowType(rawValue: index) == nil)
...
@_spi(PlexyInternal)
extension UPIComponent: PlexyObserver {}
