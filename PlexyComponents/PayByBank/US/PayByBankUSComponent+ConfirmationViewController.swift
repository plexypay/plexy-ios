...
extension PayByBankUSComponent {
    ...
    internal class ConfirmationViewController: UIViewController {
        ...
        override public var preferredContentSize: CGSize {
            get {
                view.plexy.minimalSize
            }

            // swiftlint:disable:next unused_setter_value
            set { PlexyAssertion.assertionFailure(message: """
        ...
        override public func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
            ...
            headerImageView.layer.borderColor = model.style.headerImage.borderColor?.cgColor ?? UIColor.Plexy.componentSeparator.cgColor
        }
    }
}
...
extension PayByBankUSComponent.ConfirmationViewController {
    ...
    private func setupViews() {
        headerImageView.plexy.apply(model.style.headerImage)
        
        titleLabel.text = model.title
        titleLabel.plexy.apply(model.style.title)
        
        subtitleLabel.text = model.subtitle
        subtitleLabel.plexy.apply(model.style.subtitle)
        
        messageLabel.text = model.message
        messageLabel.plexy.apply(model.style.message)
        ...
        contentButtonStack.plexy.anchor(
