...
final class CardScannerViewModelTests: XCTestCase {
    ...
    enum Constants {
        static let mockCardImage = "plexy-card-iphone-capture"
    }
    ...
    func testCameraAlertTitle() throws {
        // Given
        let expectedCameraAlertTitle = "plexy.card.scanner.camera.access.denied.alert.title"
    ...
    func testCameraAlertMessage() throws {
        // Given
        let expectedCameraAlertMessage = "plexy.card.scanner.camera.access.denied.alert.message"
    ...
    func testCameraAlertSettingButtonTitle() throws {
        // Given
        let expectedCameraAlertSettingButtonTitle = "plexy.card.scanner.camera.access.denied.alert.settingsButton.title"
    ...
    func testCameraAlertCancelButtonTitle() throws {
        // Given
        let expectedCameraAlertSettingButtonTitle = "plexy.cancelButton"
