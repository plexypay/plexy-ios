...
/**
 ...
 - SeeAlso:
 [Implementation Reference](https://docs.plexy.com/online-payments/ios/drop-in)
 */
public final class DropInComponent: NSObject,
    ...
    private lazy var actionComponent: PlexyActionComponent = {
...
@_spi(PlexyInternal)
extension DropInComponent: PlexySessionAware {
    public var isSession: Bool {
        delegate is PlexySessionAware
    }
}
