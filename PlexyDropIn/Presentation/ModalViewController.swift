...
internal final class ModalViewController: UIViewController {
    ...
    override public func viewDidLayoutSubviews() {
        ...
        view.plexy.round(corners: [.topLeft, .topRight], radius: style.cornerRadius)
    }
    ...
    private func getSeparatorColor() -> UIColor {
        switch navBarType {
        case .regular:
            return style.separatorColor ?? UIColor.Plexy.componentSeparator
        case .custom:
    ...
    private func arrangeConstraints() {
        ...
        stackView.plexy.anchor(inside: view)
