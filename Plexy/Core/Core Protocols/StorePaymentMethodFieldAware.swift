...
@_spi(PlexyInternal)
public protocol StorePaymentMethodFieldAware: PlexySessionAware {
...
@_spi(PlexyInternal)
public protocol SessionStoredPaymentMethodsDelegate: PlexySessionAware, StoredPaymentMethodsDelegate {
