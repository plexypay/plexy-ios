...
public protocol ImageLoading {
    @discardableResult
    func load(url: URL, completion: @escaping ((UIImage?) -> Void)) -> PlexyCancellable
}
...
public final class ImageLoader: ImageLoading {
    ...
    @discardableResult
    public func load(url: URL, completion: @escaping ((UIImage?) -> Void)) -> PlexyCancellable {
        var urlSessionTask: URLSessionTask?
        let task = PlexyTask { urlSessionTask?.cancel() }
