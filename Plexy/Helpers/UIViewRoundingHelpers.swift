...
@_spi(PlexyInternal)
public extension PlexyScope where Base: UIView {
    ...
    func round(corners: UIRectCorner, percentage: CGFloat) {
        ...
        base.plexy.round(corners: corners, radius: radius)
    }
    ...
    func round(corners: UIRectCorner, rounding: CornerRounding) {
        ...
        case let .fixed(value):
            base.plexy.round(corners: corners, radius: value)
        case let .percent(value):
            base.plexy.round(corners: corners, percentage: value)
        case .none:
            break
        }
    }
