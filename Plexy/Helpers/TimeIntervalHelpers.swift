...
/// So that any `TimeInterval` instance will inherit the `plexy` scope.
@_spi(PlexyInternal)
extension TimeInterval: PlexyCompatible {}

/// Adds helper functionality to any `TimeInterval` instance through the `plexy` property.
@_spi(PlexyInternal)
public extension PlexyScope where Base == TimeInterval {
