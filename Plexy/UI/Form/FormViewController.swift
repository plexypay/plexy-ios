...
@_spi(PlexyInternal)
open class FormViewController: UIViewController, PlexyObserver, PreferredContentSizeConsumer {
    ...
    override open func viewDidAppear(_ animated: Bool) {
        ...
        view.plexy.animate(context: AnimationContext(
    ...
    public func didUpdatePreferredContentSize() {
        ...
        view.plexy.animate(context: context)
    }
    ...
    private func setupLayout() {
        if scrollEnabled {
            scrollView.plexy.anchor(inside: view.safeAreaLayoutGuide)
            ...
            formView.plexy.anchor(inside: view.safeAreaLayoutGuide)
        }
    }
