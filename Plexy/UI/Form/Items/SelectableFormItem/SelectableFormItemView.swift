...
public final class SelectableFormItemView: FormItemView<SelectableFormItem> {
    ...
    private lazy var separator: FormSeparatorItem = {
        let separator = FormSeparatorItem(color: item.style.separatorColor ?? UIColor.Plexy.componentSeparator)
    ...
    override public func layoutSubviews() {
        ...
        imageView.plexy.round(using: item.style.imageStyle.cornerRounding)
    }
    ...
    private func configureConstraints() {
        ...
        itemButton.plexy.anchor(inside: self)
