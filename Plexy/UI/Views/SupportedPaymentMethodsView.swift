...
public class SupportedPaymentMethodLogosView: UIView {
    ...
    internal var content: UIView? {
        ...
        didSet {
            ...
            addSubview(content)
            content.plexy.anchor(inside: self)
        }
    }
    
    @PlexyDependency(\.imageLoader) private var imageLoader
    ...
    private func updateContent() {
        ...
        let imageViews = imageUrls.map { url in
            ...
            imageView.plexy.apply(style.images)
        ...
        label.plexy.apply(style.trailingText)
