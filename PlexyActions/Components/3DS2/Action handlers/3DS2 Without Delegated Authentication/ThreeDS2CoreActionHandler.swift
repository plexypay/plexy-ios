...
internal class ThreeDS2CoreActionHandler: AnyThreeDS2CoreActionHandler {
    ...
    internal func handle(
        ...
        do {
            let token = try PlexyCoder.decodeBase64(fingerprintAction.fingerprintToken) as ThreeDS2Component.FingerprintToken
    ...
    private func didReceiveErrorOnFingerprint(
        ...
        do {
            let encodedError = try PlexyCoder.encodeBase64(
    ...
    private func didFinishFingerprintSuccessfully(
        ...
        do {
            let encodedFingerprint = try PlexyCoder.encodeBase64(ThreeDS2Component.Fingerprint(
                authenticationRequestParameters: authenticationRequestParameters,
    ...
    internal func handle(
        ...
        do {
            token = try PlexyCoder.decodeBase64(challengeAction.challengeToken) as ThreeDS2Component.ChallengeToken
        } catch {
...
extension ThreeDS2CoreActionHandler: PresentationDelegate {
    func present(component: any PresentableComponent) {
        PlexyAssertion.assert(message: "presentationDelegate should not be nil", condition: presentationDelegate == nil)
