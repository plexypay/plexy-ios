...
// swiftlint:disable file_length
    ...
    internal class ThreeDS2PlusDACoreActionHandler: ThreeDS2CoreActionHandler {
        ...
        private let deviceSupportCheckerService: PlexyAuthentication.DeviceSupportCheckerProtocol
        ...
        internal init(
            ...
            deviceSupportCheckerService: PlexyAuthentication.DeviceSupportCheckerProtocol = DeviceSupportChecker()
        ) {
        ...
        private func daPayload(
            ...
            guard let token: ThreeDS2Component.FingerprintToken = try? PlexyCoder.decodeBase64(fingerprintAction.fingerprintToken),
        ...
        private func modifyFingerPrint(
            ...
            var fingerprintResult: ThreeDS2Component.Fingerprint = try PlexyCoder.decodeBase64(threeDSFingerPrint)
            ...
            let encodedFingerprintResult = try PlexyCoder.encodeBase64(fingerprintResult)
        ...
        private func userApprovedTransaction(
            ...
            authenticate(
                ...
                failedAuthenticationHandler: { [weak self] error in
                    ...
                    if case let PlexyAuthenticationError.consecutiveCancellationOnApproval(count) = error,
        ...
        internal func service(cardNumber: String?) -> AuthenticationServiceProtocol {
            ...
            return PlexyAuthentication.AuthenticationService(
        ...
        private func daPayload(_ challengeAction: ThreeDS2ChallengeAction) -> RegistrationPayload? {
            guard let token: ThreeDS2Component.ChallengeToken = try? PlexyCoder.decodeBase64(challengeAction.challengeToken),
                  let sdkInput = token.delegatedAuthenticationSDKInput else {
                return nil
            }
        ...
        private func securedCardNumber(lastFour: String?) -> String? {
            ...
            return String.Plexy.securedString + lastFour
        }
    }
