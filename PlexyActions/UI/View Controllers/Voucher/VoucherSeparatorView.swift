...
internal final class VoucherSeparatorView: UIView {
    ...
    private func buildSeparatorLines() {
        leftSeparatorLayer.backgroundColor = UIColor.Plexy.lightGray.cgColor
        rightSeparatorLayer.backgroundColor = UIColor.Plexy.lightGray.cgColor
    ...
    private func buildSeparatorTextLayer() {
        ...
        separatorTextLayer.alignmentMode = style.textAlignment.plexy.caAlignmentMode
