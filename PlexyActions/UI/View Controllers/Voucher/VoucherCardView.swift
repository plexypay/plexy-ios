...
internal class VoucherCardView: UIView {
    ...
    private func updateLayersStyle() {
        containerLayer.strokeColor = UIColor.Plexy.lightGray.withAlphaComponent(0.8).cgColor
        containerLayer.fillColor = UIColor.Plexy.componentBackground.cgColor
    }
