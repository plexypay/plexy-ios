...
internal final class QRCodeView: UIView, Localizable, PlexyObserver {
    ...
    internal init(model: Model) {
        ...
        accessibilityIdentifier = "plexy.QRCode"
    ...
    internal lazy var logo: UIImageView = {
        ...
        logo.plexy.round(using: model.style.logoCornerRounding)
    ...
    private lazy var amountToPayLabel: UILabel = {
        ...
        amountToPayLabel.font = UIFont.preferredFont(forTextStyle: .callout).plexy.font(with: .bold)
    ...
    @objc private func saveQRCodeAsImage() {
        delegate?.saveAsImage(qrCodeImage: qrCodeImageView.plexy.snapshot(), sourceView: actionButton)
    }
