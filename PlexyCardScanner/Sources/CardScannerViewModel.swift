...
extension CardScannerViewModel {
    ...
    private enum LocalizationKey: String {
        case cameraAlertTitle = "plexy.card.scanner.camera.access.denied.alert.title"
        case cameraAlertMessage = "plexy.card.scanner.camera.access.denied.alert.message"
        case cameraAlertSettingButtonTitle = "plexy.card.scanner.camera.access.denied.alert.settingsButton.title"
        case cameraAlertCancelButtonTitle = "plexy.cancelButton"
    }
