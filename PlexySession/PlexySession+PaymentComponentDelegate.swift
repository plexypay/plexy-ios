...
@_spi(PlexyInternal)
extension PlexySession: PaymentComponentDelegate {
    ...
    internal func finish(with result: PlexySessionResult, component: Component) {
...
@_spi(PlexyInternal)
extension PlexySession: PlexySessionPaymentsHandler {
