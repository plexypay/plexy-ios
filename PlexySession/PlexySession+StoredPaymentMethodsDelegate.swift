...
@_spi(PlexyInternal)
extension PlexySession: SessionStoredPaymentMethodsDelegate {
    ...
    public func disable(storedPaymentMethod: Plexy.StoredPaymentMethod, completion: @escaping Plexy.Completion<Bool>) {
        PlexyAssertion.assertionFailure(message: "Use the new delegate method from session.")
    }
}
