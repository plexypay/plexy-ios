...
Please read more [here](https://docs.plexy.com/development-resources/client-side-authentication) about the client key and how to get.
...
@TabNavigator {
    ...
    @Tab(Components) {  
        In case of using individual components, create and persist an instance of ``PlexyActionComponent``:

        ```swift
        lazy var actionComponent: PlexyActionComponent = {
