...
#if canImport(PlexyEncryption)
    import PlexyEncryption
#endif
import UIKit

internal final class StoredCardAlertManager: NSObject, UITextFieldDelegate, PlexyContextAware, Localizable {
    ...
    internal private(set) lazy var alertController: UIAlertController = {
        ...
        alertController.addTextField(configurationHandler: { [weak self] textField in
            ...
            textField.accessibilityIdentifier = "PlexyCard.StoredCardAlertManager.textField"
