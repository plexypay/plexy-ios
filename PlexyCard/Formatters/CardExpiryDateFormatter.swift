...
public final class CardExpiryDateFormatter: NumericFormatter {
    ...
    override public func sanitizedValue(for value: String) -> String {
        super.sanitizedValue(for: value).plexy.truncate(to: maxLength)
    }
    ...
    override public func formattedValue(for value: String) -> String {
        ...
        case 3:
            month = Int(sanitizedString.plexy[0...1])!
            formattedDate = sanitizedString.plexy[0...1] + separator + sanitizedString.plexy[2]
        case 4:
            month = Int(sanitizedString.plexy[0...1])!
            formattedDate = sanitizedString.plexy[0...1] + separator + sanitizedString.plexy[2...3]
        default:
            break
        }
