...
/// So that any `Array` instance will inherit the `plexy` scope.
@_spi(PlexyInternal)
extension Array: PlexyCompatible {}

/// Adds helper functionality to any `[CardType]` instance through the `plexy` property.
@_spi(PlexyInternal)
public extension PlexyScope where Base == [CardType] {
