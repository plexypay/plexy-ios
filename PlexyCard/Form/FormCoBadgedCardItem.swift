...
internal final class FormCoBadgedCardItem: FormItem {
    ...
    @PlexyObservable([]) internal var selectableFormItems: [SelectableFormItem]
    ...
    internal var isHidden: PlexyObservable<Bool> = PlexyObservable(true)
    ...
    @PlexyObservable(nil) internal var updatedCardBrands: [CardBrand]?
    ...
    internal func selectableFormItems(
        ...
        brands.map { brand in
            ...
            let selectableItem = SelectableFormItem(
                ...
                style: .init(
                    title: style.title,
                    separatorColor: UIColor.Plexy.componentSeparator
                ),
